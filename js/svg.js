...
(function(){
	...
	if(ready === "complete" || ready ==="interactive"){
  	...
  	function init(){
  		var l = arr.length,
    		list = document.querySelectorAll('[data-svg]'),
    		ll = list.length,
    	...
    	for(var i =0; i<l; i++){
    		...
    		for(var j=0; j<ll; j++){
    			if(id === list[j].getAttribute('data-svg')){
    				list[j].appendChild(div.firstChild);
    				break;
    			}
    		}
    	}
